                ...
                >
                  ...
                  <td className="p-4 text-right">
                    <button 
                      ...
                      className="text-red-400 hover:text-white bg-red-400/10 hover:bg-red-500 border border-red-400/20 hover:border-red-500 px-3 py-1 rounded-md transition-all text-xs font-medium flex items-center gap-1 ml-auto"
