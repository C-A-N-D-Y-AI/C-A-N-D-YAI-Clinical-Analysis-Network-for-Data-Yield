          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex items-center justify-between md:justify-start gap-4">
              ...
              <button onClick={openCreateModal}
                className="bg-[#0091DA] hover:bg-[#007AB8] text-[#FFFFFF] px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 active:scale-95 whitespace-nowrap shadow-lg shadow-[#0091DA]/20">
            ...
            <tbody className="text-sm">
              {filteredUsers.length === 0 ? (
                ...
                filteredUsers.map((user) => (
                  <tr key={user.id} className="border-b border-[#1A263D]/50 hover:bg-[#1A263D]/30 transition-colors">
                    <td className="p-4 font-medium text-[#FFFFFF]">{user.firstName} {user.lastName}</td>
                    <td className="p-4 text-[#A0AEC0]">{user.email}</td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      <span className={`flex items-center gap-2 text-xs font-medium ${user.isActive ? "text-[#00C2A8]" : "text-red-400"}`}>
                        <span className={`w-2 h-2 rounded-full ${user.isActive ? "bg-[#00C2A8] shadow-[0_0_5px_#00C2A8]" : "bg-red-400"}`}></span>
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button onClick={() => openEditModal(user)}
                          className="text-[#0091DA] hover:text-white bg-[#0091DA]/10 hover:bg-[#0091DA] border border-[#0091DA]/20 px-3 py-1.5 rounded-md transition-all text-xs font-medium flex items-center gap-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button onClick={() => handleDelete(user)}
                          className="text-red-400 hover:text-white bg-red-400/10 hover:bg-red-500 border border-red-400/20 px-3 py-1.5 rounded-md transition-all text-xs font-medium flex items-center gap-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
