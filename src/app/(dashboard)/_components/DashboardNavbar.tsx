...
export default function DashboardNavbar({ user }: DashboardNavbarProps) {
  ...
  return (
    <nav className="relative z-50 flex items-center justify-between bg-[#020617] px-8 py-4 backdrop-blur-xl">
      ...
      <style jsx>{`
        ...
        .animate-nav-rotate3d { animation: nav-rotate3d 5s ease-in-out infinite; }
        .n-face { position: absolute; background: white; border: 0.5px solid rgba(14,165,233,0.2); }
